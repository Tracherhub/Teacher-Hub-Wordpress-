...
class Workup_Widget_Job_Buttons extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_job_buttons',
            esc_html__('Job Detail:: Apply/Shortlist Buttons', 'workup'),
            array( 'description' => esc_html__( 'Show job buttons', 'workup' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('show_apply_button') ); ?>">
                <?php esc_html_e('Show Apply Button', 'workup'); ?>
            </label>
        </p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('show_apply_social') ); ?>">
                <?php esc_html_e('Show Social Apply', 'workup'); ?>
            </label>
        </p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('show_shortlist_button') ); ?>">
                <?php esc_html_e('Show Shortlist Button', 'workup'); ?>
            </label>
        </p>
<?php
    }
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Workup_Widget_Job_Buttons');
}