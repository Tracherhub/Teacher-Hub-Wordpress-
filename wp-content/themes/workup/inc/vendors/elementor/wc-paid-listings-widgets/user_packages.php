...
class Workup_Elementor_Jobs_User_Packages extends Elementor\Widget_Base {

	public function get_name() {
        return 'workup_jobs_user_packages';
    }

	public function get_title() {
        return esc_html__( 'Apus User Packages', 'workup' );
    }
    
	public function get_categories() {
        return [ 'workup-jobs-elements' ];
    }
            ...
            <div class="inner-list">
                ...
                <?php if ( ! is_user_logged_in() ) {
                    ...
                    <div class="box-list-2">
                        <div class="text-warning"><?php  esc_html_e( 'Please login with "Employer" to see this page.', 'workup' ); ?></div>
                    </div>  
                    <?php
                } else {
                        ...
                        <div class="widget-user-packages <?php echo esc_attr($el_class); ?>">
                            <div class="widget-content table-responsive">
                                <table class="user-packages">
                                    <thead>
                                        <tr>
                                            <td><?php esc_html_e('ID', 'workup'); ?></td>
                                            <td><?php esc_html_e('Package', 'workup'); ?></td>
                                            <td><?php esc_html_e('Package Type', 'workup'); ?></td>
                                            <td><?php esc_html_e('Package Info', 'workup'); ?></td>

                                            <td><?php esc_html_e('Status', 'workup'); ?></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                    ...
                                                    <?php
                                                        switch ($package_type) {
                                                            case 'cv_package':
                                                                ...
                                                                <ul class="lists-info">
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('CV Count:', 'workup'); ?></span>
                                                                        <span class="value"><?php echo intval($cv_viewed_count); ?></span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('Expiry Time:', 'workup'); ?></span>
                                                                        <span class="value"><?php echo sprintf(_n('%d Day', '%d Days', intval($cv_package_expiry_time), 'workup'), intval($cv_package_expiry_time)); ?></span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('CV Limit:', 'workup'); ?></span>
                                                            ...
                                                            case 'contact_package':
                                                                ...
                                                                <ul class="lists-info">
                                                                    ...
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('Expiry Time:', 'workup'); ?></span>
                                                                        <span class="value"><?php echo sprintf(_n('%d Day', '%d Days', intval($contact_package_expiry_time), 'workup'), intval($contact_package_expiry_time)); ?></span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('CV Limit:', 'workup'); ?></span>
                                                            ...
                                                            case 'candidate_package':
                                                                ...
                                                                <ul class="lists-info">
                                                                    ...
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('Expiry Time:', 'workup'); ?></span>
                                                                        <span class="value"><?php echo sprintf(_n('%d Day', '%d Days', intval($candidate_package_expiry_time), 'workup'), intval($candidate_package_expiry_time)); ?></span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('CV Limit:', 'workup'); ?></span>
                                                            ...
                                                            case 'resume_package':
                                                                ...
                                                                <ul class="lists-info">
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('Urgent:', 'workup'); ?></span>
                                                                        <span class="value">
                                                                            <?php
                                                                                if ( $urgent_resumes == 'on' ) {
                                                                                    esc_html_e('Yes', 'workup');
                                                                                } else {
                                                                                    esc_html_e('No', 'workup');
                                                                                }
                                                                            ?>
                                                                        </span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('Featured:', 'workup'); ?></span>
                                                                        <span class="value">
                                                                            <?php
                                                                    ...
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('Resume Duration:', 'workup'); ?></span>
                                                            ...
                                                            default:
                                                                ...
                                                                <ul class="lists-info">
                                                                    ...
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('Posted:', 'workup'); ?></span>
                                                                        <span class="value"><?php echo intval($package_count); ?></span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('Limit Posts:', 'workup'); ?></span>
                                                                        <span class="value"><?php echo intval($job_limit); ?></span>
                                                                    </li>
                                                                    <li>
                                                                        <span class="title"><?php esc_html_e('Listing Duration:', 'workup'); ?></span>
                                                ...
                                                <td>
                                                    ...
                                                    <?php
                                                        ...
                                                        if ( !$valid ) {
                                                            echo '<span class="action finish">'.esc_html__('Finished', 'workup').'</span>';
                                                        } else {
                                                            echo '<span class="action active">'.esc_html__('Active', 'workup').'</span>';
                                                        }
                                                    ?>
                                                </td>
                                            </tr>
                    ...
                    <?php } else { ?>
                        <div class="not-found"><?php esc_html_e('Don\'t have any packages', 'workup'); ?></div>
                    <?php } ?>
                <?php } ?>
            </div>
        </div>
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Workup_Elementor_Jobs_User_Packages );