...
class Workup_Elementor_Features_Box extends Widget_Base {

	public function get_name() {
        return 'workup_features_box';
    }

	public function get_title() {
        return esc_html__( 'Apus Features Box', 'workup' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Features Box', 'workup' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => '',
                'placeholder' => esc_html__( 'Enter your Number', 'workup' ),
            ]
        );
        $repeater->add_control(
            'title_text',
            [
                'label' => esc_html__( 'Title & Description', 'workup' ),
        ...
        $this->start_controls_section(
            'section_icon_style',
            [
                'label' => esc_html__( 'Icon Style', 'workup' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'icon_bg_color',
            [
                'label' => esc_html__( 'Icon BG Color', 'workup' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_control(
            'num_color',
            [
                'label' => esc_html__( 'Number Bg Color', 'workup' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
...
Plugin::instance()->widgets_manager->register_widget_type( new Workup_Elementor_Features_Box );