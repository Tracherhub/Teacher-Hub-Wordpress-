					    ...
					    <div class="job-information">
							...
							<?php if ( $employer_id ) { ?>
						        <div class="job-date-author">
						            <?php echo sprintf(wp_kses(__('<a class="text-theme" href="%s">%s</a>', 'workup'), array( 'a' => array('class' => array(), 'href' => array()) ) ), get_permalink($employer_id), get_the_title($employer_id) ); ?>
						        </div>
						    <?php } ?>
