...
class WP_Job_Board_Post_Type_Job_Listing {
	...
	public static function init() {
		...
		add_action( 'wp_ajax_nopriv_wp_job_board_ajax_remove_job',  array(__CLASS__,'process_remove_job') );
	}
	...
	public static function process_remove_job() {
		...
		$is_allowed = WP_Job_Board_Mixes::is_allowed_to_remove( get_current_user_id(), $job_id );
