        ...
        if ($consumer_key != '' && $consumer_secret != '') {
            ...
            switch ($connection->http_code) {
                ...
                default:
                    ...
                    esc_html_e('There is problem while connecting to twitter', 'wp-job-board');
            }
            exit();
        }
        wp_die();
    ...
    private function create_user() {
        ...
        if (isset($twitter_user->email)) {
            ...
            if (is_object($_social_user_obj) && isset($_social_user_obj->ID)) {
                update_user_meta($_social_user_obj->ID, 'wp_job_board_twitter_id', $twitter_user->id);
                $this->login_user();
            }
        }
        ...
        $userdata = apply_filters('wp-job-board-twitter-login-userdata', $userdata, $twitter_user);
        ...
        if ( ! is_wp_error( $user_id ) ) {
            ...
            update_user_meta($user_id, 'wp_job_board_twitter_id', $twitter_user->id);
